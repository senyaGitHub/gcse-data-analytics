...
girls_grades = df_girls['5+ A*-C inc. English & mathematics']
boys_grades = df_boys['5+ A*-C inc. English & mathematics']

# Plot histograms and Q-Q plots
fig, axs = plt.subplots(2, 2, figsize=(12, 10))

# Histograms
sns.histplot(girls_grades, bins=10, kde=True, ax=axs[0, 0], color='blue')
axs[0, 0].set_title('Histogram of Girls Grades')
axs[0, 0].set_xlabel('5+ A*-C inc. English & Mathematics')
axs[0, 0].set_ylabel('Frequency')

sns.histplot(boys_grades, bins=10, kde=True, ax=axs[0, 1], color='green')
axs[0, 1].set_title('Histogram of Boys Grades')
axs[0, 1].set_xlabel('5+ A*-C inc. English & Mathematics')
axs[0, 1].set_ylabel('Frequency')

# Q-Q plots
stats.probplot(girls_grades, dist="norm", plot=axs[1, 0])
axs[1, 0].set_title('Q-Q Plot of Girls Grades')

stats.probplot(boys_grades, dist="norm", plot=axs[1, 1])
axs[1, 1].set_title('Q-Q Plot of Boys Grades')

plt.tight_layout()
plt.show()

# Perform Shapiro-Wilk test for normality
shapiro_girls = stats.shapiro(girls_grades)
shapiro_boys = stats.shapiro(boys_grades)

shapiro_girls, shapiro_boys
